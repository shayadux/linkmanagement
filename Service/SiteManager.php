...
class SiteManager{
    ...
    /**
     * Get the siteId and URL for all the sites
     * @return type
     */
    ...
    /**
     * Update the Google PageRank that's stored in the Sites table
     * @param type $googlePR
     * @param type $siteId
     */
    ...
    /**
     * Update the Alexa GlobalRank that's stored in the Sites table
     * @param type $alexaGR
     * @param type $siteId
     */
